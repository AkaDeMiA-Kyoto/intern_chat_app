...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME"),  # .envのDB_NAMEを読み込む
        "USER": os.getenv("DB_USER"),  # .envのDB_USERを読み込む
        "PASSWORD": os.getenv("DB_PASSWORD"),  # .envのDB_PASSWORDを読み込む
        "HOST": os.getenv(
            "DB_HOST", "localhost"
        ),  # .envのDB_HOSTを読み込む（デフォルトはlocalhost）
        "PORT": os.getenv(
            "DB_PORT", "5432"
        ),  # .envのDB_PORTを読み込む（デフォルトは5432）
    }
}
