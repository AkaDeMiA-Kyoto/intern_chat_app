...
class CustomUser(AbstractUser):
    username = models.CharField('Username', max_length=15, null=False, blank=False, unique=True)
    ...
    image = models.ImageField('プロフィール画像', upload_to="", blank=False, null=False, default="")
